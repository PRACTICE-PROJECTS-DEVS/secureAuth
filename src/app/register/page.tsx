    ...
    return (
      <AuthCard>
        <div className="text-center py-8 animate-fade-up">
          ...
          <p className="text-muted font-mono text-sm">Redirecting you to login…</p>
    ...
    <>
      ...
      <AuthCard>
        ...
        <div className="text-center mb-8 animate-fade-up">
          ...
          <p className="text-muted text-sm font-mono mt-1">Join SecureAuth — MFA protected</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="animate-fade-up delay-100">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3.5 rounded-xl border bg-surface2 font-mono text-sm
          ...
          <div className="animate-fade-up delay-200">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-12 py-3.5 rounded-xl border bg-surface2 font-mono text-sm
                  text-[#e8eaf6] placeholder:text-muted outline-none transition-all duration-200
                  ${errors.password
                    ? 'border-danger focus:border-danger shadow-[0_0_10px_rgba(248,113,113,0.1)]'
                    : 'border-border focus:border-accent/60 focus:shadow-[0_0_12px_rgba(74,222,128,0.1)]'}`}
                  ...
                  return (
                    <div key={key} className="flex items-center gap-1.5">
                      <div className={`w-3.5 h-3.5 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-200
                        ${met ? 'bg-accent/20 border border-accent' : 'bg-surface2 border border-border'}`}>
                        {met && (
                      ...
                      <span className={`text-[11px] font-mono transition-colors ${met ? 'text-accent' : 'text-muted'}`}>
                        {label}
                      </span>
                    </div>
                  );
            ...
            <div className="relative">
              ...
              <div className="absolute right-3.5 top-1/2 -translate-y-1/2 flex items-center gap-2">
                ...
                <button type="button" onClick={() => setShowConfirm(!showConfirm)}
                  className="text-muted hover:text-[#e8eaf6] transition-colors">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl font-bold text-sm bg-accent text-bg
        ...
        {/* Footer */}
        <div className="mt-6 pt-5 border-t border-border flex items-center justify-between animate-fade-up delay-500">
          <span className="text-xs text-muted font-mono">Already have an account?</span>
          <Link href="/login"
            className="text-xs font-bold text-accent hover:text-accent/80 font-mono transition-colors flex items-center gap-1">
            Sign in
        ...
        {/* Security badge */}
        <div className="mt-4 flex items-center justify-center gap-1.5 text-xs text-muted font-mono">
